...
from main import _build_device
...
def set_button(vendor_id: int, product_id: int, button: str, action: str) -> None:
    ...
    :param button: button name (e.g. 'left_click', 'dpi_plus')
    :param action: action name (e.g. 'right_click', 'disable')
    """
    ...
    HIDIOCSFEATURE_520 = (3 << 30) | (ord('H') << 8) | 0x06 | (520 << 16)
...
set_button(0x258a, 0x002f, 'dpi_plus', 'dpi_plus')
